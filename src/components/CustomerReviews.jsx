  ...
  const reviews = [
    {
      ...
      verified: true,
      rating: 5,
      comment: "Presentación 10/10. El aroma es diferente a todo lo que he probado: transmite puro lujo y elegancia. ¡Fijación muy potente!",
    ...
    },
    {
      ...
      verified: true,
      rating: 5,
      comment: "¡Totalmente recomendada esta fragancia! Es un 10 de 10 indiscutible, ¡definitivamente vale la pena comprarla! Llueven los cumplidos.",
    ...
    },
    {
      ...
      verified: true,
      rating: 5,
      comment: "Cómprenlo, está muy rico. La fijación es excelente y las notas dulces son súper delicadas, sofisticadas y atractivas.",
    ...
    },
    {
      ...
      verified: true,
      rating: 5,
      comment: "¡Huele increíble! Probé Khamrah: catalogada como unisex, pero con un aroma audaz, cálido, dulce-especiado y muy atractivo.",
    ...
    },
    {
      ...
      verified: true,
      rating: 5,
      comment: "Aroma perfectamente equilibrado, suave y cálido que te envuelve. Proyecta 3 horas y dura más de 8 horas en piel. ¡100% recomendado!",
    ...
    },
    {
      ...
      verified: true,
      rating: 5,
      comment: "ASAD abre de forma intensa y especiada, pero el secado en piel es verdaderamente hermoso con notas cálidas de vainilla.",
      productTitle: "Asad",
    ...
    },
    {
      ...
      verified: true,
      rating: 5,
      comment: "Yara Candy es dulce, frutal y deliciosa. ¡La recomiendo totalmente! La presentación en persona es espectacular.",
            ...
            <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-1.5">
                  ...
                  <span className="text-[11px] font-medium text-amber-900/80 bg-amber-100/70 px-2 py-0.5 rounded-full">Comprador Verificado</span>
                </div>
